...
const AboutScreen = () => {
  ...
  <div>
    ...
    <div className="card">
      <div style={{ fontWeight: 800, marginBottom: 6 }}>{t('Pause anytime')}</div>
      <p style={{ margin: 0, lineHeight: 1.55, fontSize: 14 }}>
    ...
    <div className="card">
      <div style={{ fontWeight: 800, marginBottom: 6 }}>{t('The meal plan is optional')}</div>
      <p style={{ margin: 0, lineHeight: 1.55, fontSize: 14 }}>
    ...
    <div className="btn-grid" style={{ marginTop: 4 }}>
      <Link className="btn ghost" to="/legal/terms" style={{ textDecoration: 'none' }}>
        {t('Terms of Use')}
      </Link>
      <Link className="btn ghost" to="/legal/privacy" style={{ textDecoration: 'none' }}>
        {t('Privacy Policy')}
      </Link>
    </div>
